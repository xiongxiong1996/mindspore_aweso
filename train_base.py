...
parser.add_argument('--resnet50path', default='', type=str, metavar='path', help='path to resnet50path (default: none)')
...
def main():
    ...
    def train_loop(model,model2, dataset, loss_fn, optimizer):
        ...
        # Get gradient function
        grad_fn2 = ops.value_and_grad(forward_fn2, None, optimizer.parameters, has_aux=True)
        ...
        pad_side = 224  # pad参数
        Pad_ops = ops.Pad(((0, 0), (0, 0), (pad_side, pad_side), (pad_side, pad_side)))
